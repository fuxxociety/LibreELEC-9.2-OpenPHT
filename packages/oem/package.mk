...
PKG_DEPENDS_TARGET="toolchain btrfs-progs-oem f2fs-tools vim-system retroarch mame2003-plus-libretro snes9x-libretro snes9x2010-libretro flycast-libretro mupen64plus-next-libretro quicknes-libretro mgba-libretro fbneo-libretro dosbox-svn-libretro scummvm-libretro vice-libretro puae-libretro desmume-libretro ppsspp-libretro dolphin-libretro ppsspp joyutils sdl-jstest emulationstation dosbox-sdl2 scraper rsync unrar p7zip transmission SABnzbd htop-oem cgroup-tools tcpdump file mediainfo alsa-plugins strace screen headless-agent plymouth-lite ttyd-oem nfs-utils autofs chdman repository.castagnait"
PKG_SECTION="oem"
