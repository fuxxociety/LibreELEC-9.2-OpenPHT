...
PKG_DEPENDS_TARGET="toolchain xfsprogs btrfs-progs-oem f2fs-tools vim-system retroarch fuse-libretro snes9x-libretro snes9x2010-libretro flycast-libretro mupen64plus-next-libretro quicknes-libretro mgba-libretro fbneo-libretro dosbox-svn-libretro scummvm-libretro vice-libretro puae-libretro desmume-libretro ppsspp-libretro genesis-plus-gx-libretro joyutils sdl-jstest emulationstation dosbox-sdl2 scraper rsync unrar p7zip transmission SABnzbd htop-oem cgroup-tools tcpdump file mediainfo alsa-plugins strace screen headless-agent plymouth-lite ttyd-oem nfs-utils autofs chdman dec-decode wit pkgrip pyudev connman-json-client"
PKG_SECTION="oem"
