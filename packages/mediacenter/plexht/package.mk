...
PKG_NAME="plexht"
PKG_VERSION="ac2478f25"
PKG_ARCH="any"
PKG_LICENSE="GPL"
PKG_SITE="https://github.com/fuxxociety/OpenPHT.git"
PKG_URL="https://github.com/fuxxociety/OpenPHT.git"
PKG_DEPENDS_TARGET="toolchain plexht:host boost Python3 zlib bzip2 systemd pciutils lzo pcre swig:host libass enca curl rtmpdump fontconfig fribidi tinyxml libjpeg-turbo libpng tiff freetype jasper libogg libcdio libmodplug libmpeg2 taglib libxml2 libxslt yajl sqlite libvorbis flac ffmpeg breakpad"
PKG_DEPENDS_HOST="ninja:host lzo:host SDL2:host SDL2_image:host"
...
echo "CMAKE_C_COMPILER = "$CMAKE_MAKE_COMPILER
...
if [ "$KODIPLAYER_DRIVER" = bcm2835-driver ]; then
  export PYTHON_EXEC="$SYSROOT_PREFIX/usr/bin/python3"
