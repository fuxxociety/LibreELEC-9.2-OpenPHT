...
PKG_DEPENDS_TARGET="toolchain alsa-lib freetype zlib retroarch-assets retroarch-overlays libretro-core-info retroarch-joypad-autoconfig glsl-shaders ffmpeg libass openal-soft-oem"
PKG_SECTION="escalade"
PKG_SHORTDESC="Reference frontend for the libretro API."

if [ "$DISPLAYSERVER" = "x11" ]; then
  PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET libxkbcommon xkeyboard-config"
fi
