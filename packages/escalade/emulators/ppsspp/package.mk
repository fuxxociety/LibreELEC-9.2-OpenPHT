...
case $ARCH in
  x86_64)
    PKG_CMAKE_OPTS_TARGET="-DUSE_SYSTEM_FFMPEG=on -DUSING_EGL=off -DUSING_GLES2=off -DUSE_DISCORD=no"
    ;;
  arm)
    PKG_CMAKE_OPTS_TARGET="-DARMV7=on -DUSE_SYSTEM_FFMPEG=on -DUSING_EGL=off -DUSING_GLES2=on -DARM_NO_VULKAN=on -DUSE_DISCORD=no"
    ;;
esac
